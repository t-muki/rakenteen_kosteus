        ...
        <section className="paneeli paneeli--kuvaaja">
          ...
          <p className="ohje ohje--kuvaaja">
            {nakyma === 'leikkaus'
              ...
              : glaserAkseli === 'sd'
                ? <>
                    Osapaine piirtyy suorana, koska vaaka-akselina on diffuusiovastus s<sub>d</sub>
                    . Jos suora leikkaisi kyllästyskäyrän, profiili taittuu sitä pitkin ja
                    taitekohtaan tiivistyy vettä. Höyrytiivis kerros vie akselilta paljon tilaa —
                    vaihda tarvittaessa paksuusakseliin.
                  </>
                : <>
                    Vaaka-akselina on todellinen paksuus, joten kerrokset näkyvät oikeassa
                    mittasuhteessa. Osapaine ei tällä akselilla ole suora; menetelmän oma esitys on
                    s<sub>d</sub>-akseli.
                  </>}
          </p>
        </section>
