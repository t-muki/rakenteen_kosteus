      ...
      <main className="ruudukko">
        ...
        <section className="paneeli paneeli--kuvaaja">
          ...
          <p className="ohje ohje--kuvaaja">
            {nakyma === 'leikkaus'
              ? 'Kastepistekäyrä kertoo, mihin lämpötilaan asti kyseisessä kohdassa oleva vesihöyry voi jäähtyä ennen tiivistymistä. Missä se nousee lämpötilakäyrän yläpuolelle, siellä kosteus tiivistyy.'
              : glaserAkseli === 'sd'
